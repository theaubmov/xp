...
export default (API: API): TokenWrapper => ({
  getBearerToken: () => {
    const url =
      '/iam-service/oauth/token?username=test-dl&password=gaian&provider=other&grant_type=password&clientId=60e58d799594680001e19768&checkB2B=false&tenantId=60e5e3f87ec7860001b6a824'
